...
public class PrevMonthReportFragment extends Fragment {

  public static final String TAG = "PrevMonthReportFragment";

  GraphView graph;

  public static PrevMonthReportFragment newInstance() {

    Bundle args = new Bundle();

    PrevMonthReportFragment fragment = new PrevMonthReportFragment();
    fragment.setArguments(args);
    return fragment;
  }


  public PrevMonthReportFragment() {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View view = inflater.inflate(R.layout.fragment_last_month_report, container, false);
  ...
  public DataPoint[] getWithdrawDatePoints() {
    int prevMonth = PersianDate.today().getShMonth() - 1;
    List<Withdraw> withdraws = Repository.getInstance(getActivity()).getWithdrawListByMonth(prevMonth);
  ...
  public DataPoint[] getDepositDatePoints() {
    int prevMonth = PersianDate.today().getShMonth() - 1;
    List<Deposit> deposits = Repository.getInstance(getActivity()).getDepositListByMonth(prevMonth);
